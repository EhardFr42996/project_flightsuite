	...
	case SENS_MY:
		{
			...
			uiDefButS(block, NUM, 0, "Delay",(short)(10+xco),(short)(yco-44),(short)((width-22)*0.4+10), 19,
				&os->delay, 0.0, 5000.0, 0, 0, "Test for OSC SEnsor (TODO)");
			uiDefButS(block, NUM, 0, "Dur",(short)(10+xco+(width-22)*0.4+10),(short)(yco-44),(short)((width-22)*0.4-10), 19,
				&os->duration, 0.0, 5000.0, 0, 0, "ugly ... very ugly");
			uiDefButBitS(block, TOG, SENS_MY_REPEAT, 0, "REP",(short)(xco + 10 + (width-22)*0.8),(short)(yco - 44),
				(short)(0.20 * (width-22)), 19, &os->flag, 0.0, 0.0, 0, 0,
				"realy ugly");
			yco-= ysize;
			break;
		}
...
static void draw_sensor_my(uiLayout *layout, PointerRNA *ptr)
{
	uiLayout *row;
