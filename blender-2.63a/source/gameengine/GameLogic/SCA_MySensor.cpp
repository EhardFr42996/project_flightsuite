...
/** \file gameengine/GameLogic/SCA_MySensor.cpp
 *  \ingroup gamelogic
 */
...
{
	CValue* replica = new SCA_MySensor(*this);
...
PyAttributeDef SCA_MySensor::Attributes[] = {
	KX_PYATTRIBUTE_INT_RW("delay",0,100000,true,SCA_MySensor,m_delay),
	KX_PYATTRIBUTE_INT_RW("duration",0,100000,true,SCA_MySensor,m_duration),
	KX_PYATTRIBUTE_BOOL_RW("repeat",SCA_MySensor,m_repeat),
	{ NULL }	//Sentinel
};
