...
static void rna_def_my_sensor(BlenderRNA *brna)
{
	StructRNA *srna;
	srna = RNA_def_struct(brna, "mySensor", "Sensor");
	RNA_def_struct_ui_text(srna, "mySensor", "Sensor for OSC int future");
}
